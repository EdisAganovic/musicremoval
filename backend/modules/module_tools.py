...
STANDALONE: Can run independently via `python -m backend.modules.module_tools list_tracks <file>`

USAGE:
  python -m backend.modules.module_tools list_tracks <video_file>  → List all audio tracks with language
