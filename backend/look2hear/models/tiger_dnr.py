...
class TIGERDNR(BaseModel):
    ...
    def wav_chunk_inference(self, model, mixture_tensor, target_length=12.0, hop_length=4.0, batch_size=1, n_tracks=3, progress_callback=None, pass_name="Dialogue", pass_idx=0, total_passes=3):
        """
        Input:
