...
import { Download, Youtube, CheckCircle, AlertCircle, Video, Music, Loader2, Link, Search } from 'lucide-react';
        ...
        <div className="space-y-8 max-w-3xl mx-auto pb-10">
            ...
            >
                ...
                <motion.button
                    ...
                    className={`w-full py-5 rounded-2xl font-bold text-xl shadow-2xl flex items-center justify-center space-x-3 transition-all duration-300 overflow-hidden relative group
                        ...
                        <div className="flex justify-between items-end relative z-10">
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <span className={`font-bold text-lg ${status === 'completed' ? 'text-emerald-400' : 'text-white'}`}>
